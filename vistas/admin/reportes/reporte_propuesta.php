...
<div class="ch-container">
    ...
    <div id="content" class="col-lg-10 col-sm-10">
        ...
        <div class="box-header well" data-original-title="">
            <h2><i class="glyphicon glyphicon-book"></i> Reporte de Propuesta</h2>
        </div>
            ...
            echo '<tr>';
              ...
              //  $evaluador=$eva->buscarEvaluadorIdentificacion($prop['evaluador_propuesta']);
                ...
                echo ' <td class="center">'.$prop['presupuesto'].'</td>
                 ...
                 $rubros=$proyRubro->listaRubrosPorPropuesta($prop['id_propuesta']);
                ...
                endforeach;
                 ...
                 echo '</td><td class="center">'.$prop['estado'].'</td>
