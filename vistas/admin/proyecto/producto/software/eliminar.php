    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-trash"></i> Eliminar Software</h2>
            </div>
            <div class="box-content">
                
            <form class="form-inline" role="form" method="post" id="form1" name="form1" action="../../../../../controller/software.php?opc=3">
