    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-edit"></i> Agregar Cap&iacute;tulo del Libro</h2>
            </div>
            <div class="box-content">
                ...
                <form class="form-inline" role="form" method="post" name="for" id="for" action="../../../../../controller/capitulo_libro.php?opc=1" onSubmit="return validar(this)">
                    <div class="form-group">
                        ...
                        <label class="control-label" for="inputSuccess4">T&iacute;tulo de Cap&iacute;tulo: <span title="Campo Obligatorio" style="color: red; font-size: 12pt;">*</span></label>
                        <input type="text" class="form-control" name="titulo_capitulo" id="titulo_capitulo" >
                        <br/><br/>
                        ...
                        <input type="text" class="form-control" name="titulo_libro" id="titulo_libro" >
                        <br/><br/>
