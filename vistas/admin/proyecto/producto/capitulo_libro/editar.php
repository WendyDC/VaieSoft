...
$id=$_GET['id'];
$editar=$lib->buscarCapituloLibro($id);
...
?>
    <script type="text/javascript">
        function validar(f) {
            ...
            if(f.titulo_capitulo.value == ''){
                alert('Por favor llene el campo Titulo del Capitulo');
                f.titulo_capitulo.focus();
                condicion=false;
                return false;
            }

            if(f.titulo_libro.value == ''){
                alert('Por favor llene el campo Titulo del Libro');
                f.titulo_libro.focus();
                condicion=false;
                return false;
            }
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-edit"></i> Editar Cap&iacute;tulo del Libro</h2>
            </div>
            <div class="box-content">
                
                <form class="form-inline" role="form" method="post" name="for" id="for" action="../../../../../controller/capitulo_libro.php?opc=2" onSubmit="return validar(this)" >
                    <div class="form-group">
                        <br/>
                        <input name="id_capitulo" type="hidden" value="<?php echo $editar['id_capitulo']?>"/>
                        <input name="id_proyecto" type="hidden" value="<?php echo $editar['id_proyecto']?>"/>
                        <label class="control-label" for="inputSuccess4">T&iacute;tulo del Cap&iacute;tulo: <span title="Campo Obligatorio" style="color: red; font-size: 12pt;">*</span></label>
                        <input type="text" class="form-control" name="titulo_capitulo" id="titulo_capitulo" value="<?php echo $editar['titulo_capitulo']?>">
                        <br/><br/>
                        <label class="control-label" for="inputSuccess4">T&iacute;tulo del Libro: <span title="Campo Obligatorio" style="color: red; font-size: 12pt;">*</span></label>
                        <input type="text" class="form-control" name="titulo_libro" id="titulo_libro" value="<?php echo $editar['titulo_libro']?>">
                        <br/><br/>
