...
$id_proyecto=$_GET['id'];
$contrapartida=$cont->listaContrapartidaDisponibles($id_proyecto);
...
?>
    <script type="text/javascript">
        function validar(f) {
            ...
            if( condicion!=false ) {    
                document.getElementById("form1").action="../../../../controller/proyectoRubro.php?opc=5";
                ...
                <form class="form-inline" role="form" method="post" name="form1" id="form1" onSubmit="return validar(this)">
                    <div class="form-group">
                      ...
                      <label class="control-label" for="inputSuccess4">Rubro:<span title="Campo Obligatorio" style="color: red; font-size: 12pt;">*</span></label>                        
                        ...
                        <input type="text" class="form-control" name="valor" required onkeypress="return permite(event, 'num')" >
